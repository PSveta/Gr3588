// Задайте двумерный массив  из целых числел.
//Напишите программу, которая удалит строчку и столбец, на пересечении которой расположен наименьший элемент массива
...
(int x, int y) SearchMinElementIn2DArray(int[,] matrix) //Композитный тип (начинается с (int ...))
{
    int row = 0;
    int collumn = 0;
...
// Метод преобразовывает массив, после удаления строки и столбца
