// Задача N42 Напишите программу, которая будет преобразовывать десятичное число в двоичное.
...
//  Метод конвертирует из десятичной в двоичную
...
//  Метод конвертирует из десятичной в двоичную - встроенный
