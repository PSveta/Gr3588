// Задача No39 Напишите программу, которая перевернёт одномерный массив (последний элемент будет напервом месте, а первый - на последнем и т.д.)
...
int[] SwapArray(int[] arr)   // Метод принимает массив на разворот
{
    int bufElement = 0;
...
int[] SwapNewArray(int[] arr)  //Метод создает новый массив
{
